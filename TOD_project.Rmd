...
### Bachelor's Degrees
The share of adults holding Bachelor's Degrees is highest in the TOD tracts, with a few exceptions in the South. With regards to growth, neither TOD and non-TOD tracts improve very significantly between 2010 and 2018. This result suggests that tracts with TOD are likely to have more educated residents, although it is unclear whehter the presence of TOD is what attracts them.
...
#ggplot() +   
 ...
 #                   name = "Rent\n(Quintile Breaks)") +
 # geom_sf(data=allTracts.group, aes(fill = q5(Rent.inf))) +
 # geom_sf(data=crime.sf, show.legend = "point", size= 0.5, color = "yellow") +
